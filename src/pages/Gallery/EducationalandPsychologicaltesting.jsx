...
const areaImagesImport = import.meta.glob("../../assets/Gallery/E&Ptesting/*.jpg");
    ...
    <div>
      ...
      <section className="gallery-hero">
        ...
        <div className="hero-content">
          <h2>Educational and Psychological Testing</h2>
          <nav className="breadcrumb">
            <FaHome className="breadcrumb-icon" /> {/* Home icon */}
            <Link to="/">Home</Link> &gt;
            <span>Educational and Psychological Testing</span>
          </nav>
        </div>
      </section>
